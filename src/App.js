     ...
     <div id='adjustments'>
        <div id='break-box'>
          ...
          <div className='toolbox'>
            <button id='break-decrement' className='btn' onClick={handleBreakDecrement} disabled={isDisabled}>
              <FontAwesomeIcon icon={faAngleDown} className='icon'/>
            </button>
            <div id='break-length'>{breakLength}</div>
            <button id='break-increment' className='btn' onClick={handleBreakIncrement} disabled={isDisabled}>
       ...
       <div id='session-box'>
          ...
          <div className='toolbox'>
            <button id='session-decrement' className='btn' onClick={handleSessionDecrement} disabled={isDisabled}>
              <FontAwesomeIcon icon={faAngleDown} className='icon'/>
            </button>
            <div id='session-length'>{sessionLength}</div>
            <button id='session-increment' className='btn' onClick={handleSessionIncrement} disabled={isDisabled}>
              <FontAwesomeIcon icon={faAngleUp} className='icon'/>
            </button>
          </div>
        </div>
